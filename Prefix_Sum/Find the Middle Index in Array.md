Here we are finding that element in an array where the subarray to its left and its right have equal sums (but we exclude the element itself in the subarray sum)
